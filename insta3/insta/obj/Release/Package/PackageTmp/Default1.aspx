<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default1.aspx.cs" Inherits="insta.Default1" %>
    ...
    <table id="tbl_header">
      ...
      <div id="fs_toggle"><i class="fa fa-expand button"></i></div>
       ...
       <div id="headerControl" class="control-bar" enabletheming="False">
        <div class="control-bar-content">
            <asp:TextBox ID="searchBox" placeholder="Search term(s"  runat="server" Style="color: #333;" AutoCompleteType="Search" ></asp:TextBox>
                  ...
                  <div class="control-bar-header">Blocks: </div>
        <div class="control-bar-content">
           ...
           <asp:RadioButton ID="RdTag" runat="server"  Text="Tag" GroupName="EndPoint" ViewStateMode="Enabled" />
            <asp:RadioButton ID="RdUser" runat="server" Text="User" GroupName="EndPoint" ViewStateMode="Enabled" />
            <asp:Button ID="Specailbtn" class="button ok" runat="server" Text="Full Search" OnClick="Specailbtn_Click1" />
        ...
        <div class="control-bar-content">
           ...
           <div id="ruleHolder">
            <asp:Label ID="ruleLabel1" runat="server"></asp:Label>
           </div>     
        </div>
       </div>
       ...
       <br />
         ...
         <asp:TextBox ID="Result" runat="server" Height="40px" TextMode="MultiLine" Width="500px"></asp:TextBox>
